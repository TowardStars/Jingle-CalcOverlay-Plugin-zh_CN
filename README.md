# Jingle Calc Overlay Plugin 的简中汉化版本

建议使用汉化版jingle使用此插件，原版jingle可能会出现问题，这与jingle的配置文件位置有关。  

将默认字体该为了微软雅黑，原默认字体不支持中文，你也可以配置自己喜欢的字体。

顺手修复了不能更改字字体颜色的bug，这可能与中文操作系统环境有关。

欢迎各位使用以及提出修改建议，未来会随着原作者的更新而更新。
